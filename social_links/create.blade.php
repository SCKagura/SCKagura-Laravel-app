                    ...
                    <form method="POST" action="{{ route('social-links.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input id="platform" name="platform" type="text"
                                   ...
                                   value="{{ old('platform') }}" placeholder="e.g., Facebook, X, LinkedIn" required>
                            @error('platform')
                        ...
                        <div>
                            ...
                            <input id="url" name="url" type="url"
                                   class="mt-2 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm
                                          focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:text-gray-100"
                                   value="{{ old('url') }}" placeholder="https://example.com/your-profile" required>
                            @error('url')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
