<section>
    ...
    {{-- Form ส่งอีเมลยืนยันใหม่ --}}
    <form id="send-verification" method="post" action="{{ route('verification.send') }}">
        @csrf
    </form>

    {{-- ฟอร์มอัปเดตชื่อ/อีเมล --}}
    ...
    {{-- ส่วนแสดง Bio + ปุ่มจัดการ Bio --}}
    <div class="mt-6">
        <h4 class="font-medium text-blue-900 dark:text-blue-200 mb-3">
            {{ __('Bio Information') }}
        </h4>

        <p class="mt-1 mb-4 text-gray-700 dark:text-gray-300">
            {{ $user->bio->bio ?? __('No bio available') }}
        </p>
        ...
        <a
            ...
            class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md
                   ...
                   active:bg-blue-700 focus:outline-none focus:border-blue-700 focus:ring ring-blue-300
